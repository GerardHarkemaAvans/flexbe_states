...
class SrdfStateToMoveit(EventState):
        ...
        -- robot_name           string              Optional name of the robot to be used.
                                                                ...
                                                                (only required if multiple robots are specified
                                                                 in the same file).
        -- tolerance            double              tolerance of the move action
        ...
        def __init__(self, config_name, move_group="", action_topic = '/move_group', robot_name="", tolerance = 0.0):
                '''
                Constructor
                '''
                ...
                if not self._param_error:
                        ...
                        for i in range(len(self._joint_names)):
                                goal_constraints.joint_constraints.append(JointConstraint(
                                        ...
                                        weight=1.0,
                                        tolerance_above = self._tolerance,
                                        tolerance_below = self._tolerance
                                        ))
